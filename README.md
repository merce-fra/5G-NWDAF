...
| --- |--------------------------------------------------------| --- | --- |
| *3GPP API*s | Model classes generated by *OpenAPI* generator.        | `./3gpp-apis` | [git@merce-gitlab.fr-merce.mee.com:artur/nwdaf-3gpp-apis.git](https://merce-gitlab.fr-merce.mee.com/gitlab/artur/nwdaf-3gpp-apis) |
